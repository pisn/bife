Meteor.myFunctions = {
	renderMeuBife : function () {
        ...
        _.each(atividadesTotal, function(atividade) {
        	...
        	if (Meteor.user().profile.activities.indexOf(userId) != -1) {
			    ...
			    thisItem += "<img src='/avatares/" + atividade.imagem + ".png' alt='' class='circle'>";
    ...
    if (typeof atividadesByTag === 'undefined') {
      ...
      var toRender = "<li class='collection-item'>Vá para <a href='/tags'>Lista de Modalidades</a> para filtrar as atividades.</li>"
      ...
      if (atividadesTotal == '') {
        ...
        var toRender = "<li class='collection-item'>Nenhuma atividade encontrada.</li><li class='collection-item'><a href='/tags' class='btn waves-effect waves-light'>Voltar para Lista de Modalidades</a></li>"
