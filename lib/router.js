...
Router.route('/meubife', function () {
  this.render('meubife');
  Session.set('showSearch', true);
  Session.set('page_title', 'Meu BIFE');
  $('.button-collapse').sideNav('hide');
});
...
Router.route('/tags', function() {
	...
	Session.set('page_title', 'Lista de Modalidades');
...
Router.route('/chav', function() {
  this.render('chav');
  Session.set('page_title', 'Chaveamentos');
  Session.set('showSearch', false);
    $('.button-collapse').sideNav('hide');
});
...
Router.route('/gerenciar_permissoes', function () {
  this.render('gerenciarPermissoes');
  Session.set('page_title', 'Gerenciar');
    $('.button-collapse').sideNav('hide');
});
